	...
	<div class="wrapper">
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="foto/<?php echo $_SESSION['user']['foto'] ?>" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark"><?php echo $_SESSION['user']['nm_lengkap'] ?></span>
              </a>
							<div class="dropdown-menu dropdown-menu-end">
								<a class="dropdown-item" href="?page=profil"><i class="align-middle me-1" data-feather="dollar-sign"></i> Profile</a>
